...
colorlist<- list(color = c(
 ...
 '#a6d96a' ))
```
####__Figure 0. Latest new cases by state__

__Daily incidence rate (average over a week)__: The most recent 7-day average of new confirmed cases per 100,000 population. 
...
plot_ly(dtafig, y=~state, x=~latestcasespp, type = 'bar', orientation='h', marker=colorlist,
    ...
    layout(
            ...
            xaxis = list(title = "per 100,000 population (latest 7-day average)") 
            )
```
