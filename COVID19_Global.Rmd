...
####__2. COVID-19 curve examples in select regions__
...
```{r plot1, results="asis", fig.align="left", out.width="800px", out.height="600px"}

dtafig<-dtacurve%>%filter(region=="South America")
...
Illustrative results for countries in Eastern Africa 
```{r plot2, results="asis", fig.align="left", out.width="800px", out.height="1000px"}

dtafig<-dtacurve%>%filter(region=="Eastern Africa")
...
Illustrative results for countries in Central Asia
```{r plot3, results="asis", fig.align="left", out.width="800px", out.height="200px"}

dtafig<-dtacurve%>%filter(region=="Central Asia")
