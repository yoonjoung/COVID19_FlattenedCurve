...
```{r plotSTATES1, results="asis", fig.align="left", out.width="800px", out.height="650px"}
...
```{r plotSTATES2, results="asis", fig.align="left", out.width="800px", out.height="650px"}
...
```{r plotSTATES3, results="asis", fig.align="left", out.width="800px", out.height="250px"}
...
* __Louisiana__ is the first among states with a high peak that made "near phase 3" in late April. At the peak, there were more than 30 daily new cases per 100,000 at one point, but the number of new cases has reduced fairly quickly and consistently. However, since late April, _the number of new cases has remained at the threshold level for a few weeks without further progress and recently has increased - now having surpassed the previous peak_.   
...
```{r plotSTATES4, results="asis", fig.align="left", out.width="800px", out.height="1850px"}
...
dtacurve%>%filter(latestlevel>=0.75)%>%
    ...
    group_by(state) %>%
    do(p = panel(.)) %>%
    subplot(nrows = 9, shareX = TRUE, shareY = FALSE)  
