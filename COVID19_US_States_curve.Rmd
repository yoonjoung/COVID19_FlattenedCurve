...
```{r plotSTATES1, results="asis", fig.align="left", out.width="800px", out.height="450px"}
...
```{r plotSTATES4, results="asis", fig.align="left", out.width="800px", out.height="2000px"}
...
dtacurve%>%filter(latestlevel>=0.75)%>%
    ...
    group_by(state) %>%
    do(p = panel(.)) %>%
    subplot(nrows = 10, shareX = TRUE, shareY = FALSE)  
