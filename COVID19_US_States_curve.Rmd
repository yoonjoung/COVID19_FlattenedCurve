...
(Last updated on `r time`. A version as of May 4th was published at [Medium](https://medium.com/@yj.choi.isquared/is-my-state-ready-to-reopen-seeing-is-believing-41ef39de663a).)
...
Only `r nstable` states (Alaska, Hawaii, Montana, and Vermont), are in the stabilization phase. Daily new cases are now lower than they were at the beginning of the wave. Reopening can continue as long as they keep a close eye on their daily new cases.

_Note: The x-axis is days from the first day of phase 1. The y-axis is daily new cases per 100,000 population (necessary for comparing big and small states). The dotted horizontal line is the number of new cases at the start of the first wave_.

_Hover over the figures to see the underlying data_.

```{r plotSTATES, results="asis", fig.align="left", out.width="800px", out.height="200px"}
...
* __New York__ joined this group on May 13th. The state had more than 50 daily new cases per 100,000 at one point - the highest peak among all states. Big admiration to all who made this progress possible in New York State!   

* Both __Michigan__ and __New Jersey__ joined this group on May 26th. 

_Note: The x-axis is days from the first day of phase 1. The y-axis is daily new cases per 100,000 population (necessary for comparing big and small states). The dotted horizontal line is a level 75% down from the peak in each state_.  
...
* In __Washington__, it is notable that the downward trajectory has stopped since mid April, after the number of new cases rapidly declined before then.   

_Note: The x-axis is days from the first day of phase 1. The y-axis is daily new cases per 100,000 population (necessary for comparing big and small states). The dotted horizontal line is a level 50% down from the peak in each state_.  

_Hover over the figures to see the underlying data_.

```{r plotSTATES2, results="asis", fig.align="left", out.width="800px", out.height="700px"}
...
_Note: The x-axis is days from the first day of phase 1. The y-axis is daily new cases per 100,000 population (necessary for comparing big and small states). The dotted horizontal line is a level 25% down from the peak in each state_.  

_Hover over the figures to see the underlying data_.

```{r plotSTATES3, results="asis", fig.align="left", out.width="800px", out.height="1000px"}
