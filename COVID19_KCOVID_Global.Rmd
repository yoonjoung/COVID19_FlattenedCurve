...
Several other countries also have entered the relatively stable phase, although the first wave started later. _Holding beginning of the first wave on day 0_, the following figure presents the length and height of the peak. Compared to South Korea, the height of the peak tends to be slightly higher, except in Greece. Also, Slovenia has just entered the relatively stable phase, and it is important to keep the number of new infections low without any rebound.
...
* Some would reach the stable phase soon if the current pace continues (e.g., Austria, Iceland, Luxembourg, and Switzerland).  
