...
Among OECD members, `r nlikeSK` other countries also have entered the relatively stable phase, although the first wave started later. _Holding beginning of the first wave on day 0_, the following figure presents the length and height of the peak. Except in Greece and now Japan as well, the peak height is taller - slightly or substantially (Iceland and Spain). And, the length of pre and post peak phases is longer. 

It is notable that two countries with a substantially high peak also have entered this phase.   
...
```{r plotSKlike_thumbnail, results="asis", fig.align="left", out.width="800px", out.height="650px"}
...
panel <- . %>% 
  plot_ly(x = ~day, y = ~newcasessmoothpp,
    ...
    layout(
        ...
        xaxis=list(range=c(0,80), showgrid = FALSE), 
...
```{r plotSKunlike1, results="asis", fig.align="left", out.width="620px", out.height="350px"}
...
```{r plotSKunlike3, results="asis", fig.align="left", out.width="620px", out.height="200px"}
