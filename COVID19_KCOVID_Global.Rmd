...
panel <- . %>% 
  plot_ly(x = ~day, y = ~newcasessmoothpp,
    ...
    layout(
        ...
        xaxis=list(range=c(0,90), showgrid = FALSE), 
...
```{r plotSKunlike3, results="asis", fig.align="left", out.width="420px", out.height="200px"}
